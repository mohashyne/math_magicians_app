...
**[Math Magicians]** Math Magicians is a React web app for all fans of mathematics. 
...
```sh
cd my-folder
git clone https://github.com/mohashyne/math_magicians_app.git
```
